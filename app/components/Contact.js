export default function Contact() {
  const whatsappMessage = encodeURIComponent('Hello, I would like a demo of your AI solutions.')
  const whatsappLink = `https://wa.me/41762404824?text=${whatsappMessage}`
      ...
      <div className="relative z-10 max-w-5xl mx-auto px-6 text-center">
        <div className="mb-12">
          <h2 className="text-5xl md:text-6xl font-bold mb-6">
            Ready to <span className="text-gradient">Stop Wasting Time?</span>
          </h2>
          <p className="text-2xl text-gray-300 mb-4">
            Book your free consultation now and see exactly how AI can transform your operations
          </p>
        ...
        <div className="flex flex-col sm:flex-row gap-6 justify-center items-center mb-16">
          ...
          <a
            href="mailto:paul@artintelligence.ch?subject=Free Consultation Request"
